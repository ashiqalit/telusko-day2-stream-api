...
//        }
      ...
      List<Product> productsByPlace = service.getProductByPlace("Shelf");
      ...
      List<Product> productsByWarranty = service.getOutOfWarrantyProducts();
      for(Product product : productsByWarranty) {
    	  System.out.println(product);
      }
    }
}